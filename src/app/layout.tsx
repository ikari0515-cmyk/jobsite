...
export const metadata: Metadata = {
  title: {
    default: "Asterisk+求人ナビ | 保育士・幼稚園教諭の求人情報",
    template: "%s | Asterisk+求人ナビ"
  },
  ...
  authors: [{ name: "Asterisk+求人ナビ運営事務局" }],
  creator: "Asterisk+求人ナビ",
  publisher: "Asterisk+求人ナビ",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
